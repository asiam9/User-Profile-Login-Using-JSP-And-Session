...
<body>
	...
	<form id="frm" action="userProfile2.jsp" method="post">
		<fieldset>
			...
			<input type="textarea" name="college" placeholder="Your College/University" required><br><br>
			...
			<input type="text" name="percentage" placeholder="Overall Percenetage" required><br>
		</fieldset>
