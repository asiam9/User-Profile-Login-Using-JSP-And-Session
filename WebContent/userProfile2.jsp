	...
	<form id="frm" action="userProfile3.jsp" method="post">
		<fieldset>
			...
			<font size="5">Employee Id</font> <input type="text" name="empid"
				placeholder="Employee Id" required> <font size="5">Name</font>
			<input type="text" name="name" placeholder="Your name(For eg. Peter)"
				required> <font size="5">Designation</font> <input
				type="text" name="job"
				placeholder="Your Designation(For eg. Trainee Programmer)" required>
			<font size="5">Company Name</font> <input type="text" name="cname"
				placeholder="Your Company(For eg. Bitwise Global)" required>
			<font size="5">Date Of Joining</font> <input type="date" name="doj"
				placeholder="Select Date of your joining" min="2000-01-01"
				max="2016-01-01" required> <font size="5">Experience</font>
